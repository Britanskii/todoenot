...
const ArrowDown = forwardRef<SVGSVGElement, ISvg>(({onClick, className = ""}, ref) => {

	return (
		<svg ref={ref} onClick={onClick} className={className} width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default motion(ArrowDown)
